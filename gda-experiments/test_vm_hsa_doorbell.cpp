...
int main() {
    ...
    volatile uint32_t *sq_doorbell_cpu = (volatile uint32_t*)((char*)bar0 + 0x1000);
    ...
    volatile uint32_t *sq_doorbell_gpu = (volatile uint32_t*)((char*)gpu_doorbell_base + offset);
