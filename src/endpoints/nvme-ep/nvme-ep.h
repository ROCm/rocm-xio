 ...
 *                       the allocation)
 * @param prpListPagePhys  Per-page physical addresses of
 *                         the PRP list pages, used to
 *                         chain a list that spans more
 *                         than one page. nullptr (the
 *                         default) keeps the list to a
 *                         single page.
 * @param prpListPageCount  Number of pages backing the
 *                          PRP list (default 1). Values
 *                          > 1 with a non-null
 *                          prpListPagePhys enable chained
 *                          PRP lists.
 */
