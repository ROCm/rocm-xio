 ...
 * Include this to use radaki_dev_* types and verbs device API from gin-ep.
 */

#ifndef ROCM_XIO_DOCA_GIN_GDAKI_H
#define ROCM_XIO_DOCA_GIN_GDAKI_H

#include "gin-ep/doca_gpunetio_dev_verbs_structs.hip.h"
...
#include "gin-ep/doca_gpunetio_dev_verbs_counter.hip.h"
#include "gin-ep/doca_gpunetio_dev_verbs_onesided.hip.h"
