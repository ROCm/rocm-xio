...
enum ib_uverbs_access_flags {
  ...
  IB_UVERBS_ACCESS_OPTIONAL_RANGE = ((IB_UVERBS_ACCESS_OPTIONAL_LAST << 1) -
                                     1) &
...
struct verbs_context {
  ...
  int (*advise_mr)(struct ibv_pd* pd, int advice, uint32_t flags,
                   struct ibv_sge* sg_list, uint32_t num_sges);
  ...
  struct ibv_rwq_ind_table* (*create_rwq_ind_table)(
    struct ibv_context* context, struct ibv_rwq_ind_table_init_attr* init_attr);
  ...
  struct ibv_srq* (*create_srq_ex)(
    struct ibv_context* context, struct ibv_srq_init_attr_ex* srq_init_attr_ex);
...
static inline struct ibv_cq_ex* ibv_create_cq_ex(
...
static inline struct ibv_pd* ibv_alloc_parent_domain(
  struct ibv_context* context, struct ibv_parent_domain_init_attr* attr) {
