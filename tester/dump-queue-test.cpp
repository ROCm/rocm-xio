...
int main() {
  ...
  std::cout << "SQ DMA: 0x" << std::hex << qinfo.sq_dma_addr << std::dec
            << std::endl;
  std::cout << "CQ DMA: 0x" << std::hex << qinfo.cq_dma_addr << std::dec
            << std::endl;
  ...
  std::cout << "Opcode: 0x" << std::hex << (int)sqe->opcode << std::dec
            << std::endl;
  std::cout << "CID: " << sqe->command_id << std::endl;
  std::cout << "NSID: " << sqe->nsid << std::endl;
  std::cout << "PRP1: 0x" << std::hex << sqe->dptr.prp.prp1 << std::dec
            << std::endl;
  std::cout << "SLBA: 0x" << std::hex
            << ((uint64_t)sqe->cdw11 << 32 | sqe->cdw10) << std::dec
            << std::endl;
